...
void ofApp::setup(){
    ...
    for (int g=0; g<triangulation.getNumTriangles(); g++){ // loop over the triangles
        FunkyTriangle tempFunkyTriangle;
        myFunkyTriangleSystem.addTriangle(tempFunkyTriangle);
    }
...
void ofApp::draw(){
    ...
    for (int g=0; g<triangulation.getNumTriangles(); g++){ // loop over the triangles
        ...
        myFunkyTriangleSystem.myFunkyTriangles[g].setup(pts[0], pts[1], pts[2]);
    }
    myFunkyTriangleSystem.draw();
